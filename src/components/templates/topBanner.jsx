...
export default function TopBanner() {
  return (
    <div className="flex flex-wrap">
      {/* Left Section */}
      <div className="flex flex-col mx-auto w-[325px] sm:w-[420px] md:w-[500px] bg-tertiary py-7 px-7 rounded-[25px] order-2 lg:order500-1  z-10 -mt-16 sm:-mt-32 lg:mt-44 lg:ms-10">
      ...
      {/* Right Section */}
      <div className="flex justify-center lg:justify-end lg:ms-32 my-10 mx-5 order-1 lg:order-2 w-full lg:-mt-80 z-0">
        <img
          src={topImage}
